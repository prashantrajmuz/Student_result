...
<center><img src="newhead.png" width="850" height="100">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">Advance Data Mining</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">AI & Machine Learning</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">Cryptography</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">Web Technology(Adv. Java)</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Computer Oriented Opt.</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Lab - 401</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Lab - 402</label>
                                    <div class="col-md-6">
...
<section>
  ...
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>Roll Number</th>
          <th>Advance Data Mining</th>
          <th>AI & Machine Learning</th>
          <th>Cryptography</th>
          <th>Web Technology(Adv. Java)</th>
          <th>Computer Oriented Optimization</th>
          <th>Lab - 401</th>
          <th>Lab - 402</th>
        </tr>
      </thead>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact NITRR(MCA).
Designed & Developed by Prashant raj</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ NITRR(MCA) :: 2020-2023</h5></center> 
  <hr class="new1">
<br>
</body>
</html>